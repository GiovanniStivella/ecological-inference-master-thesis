...
Therefore, this identity suggests a strategy that starts from local estimands, which however can be of interest on their own, to recover the global estimand.
...
Equivelantely to linear regression,CCAR would allow the following identification: $\beta = E[\overline{X}\overline{X}']^{-1}E[\overline{X}'\overline{Y}]$.
