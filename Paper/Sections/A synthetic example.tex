...
I will show that, estimating the quantities of interest with different methods, we obtain different results and the naive methods do not work well.
...
with means $\eta_{r}^{H}$ and $\eta_{r}^{L}$ defined as follows:
\begin{align*}
