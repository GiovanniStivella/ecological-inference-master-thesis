...
$\overline{Y}_g$, $\overline{X}_g$ and $Z_g$ are observed, while $\beta_g$ (and their corresponding $\eta_r$) are unobserved and are the goals of the semiparametric estimation.
