...
The example presented in Appendix A shows that a simple linear estimator can approximate a non-linear relationship with good precision. Moreover, the results of the estimates obtained with the linear estimator are almost identical to the ones obtained with the \texttt{seine} package.
