...
A famous example of that problem is the one presented by \citet{Robinson1950} for the relationships between illiteracy and race, and illiteracy and migration, in the United States. In that case, the author observed that areas with a higher proportion of Black population, as well as areas with a higher proportion of migrants, had lower illiteracy rates. However, at the individual level, Black people and migrants were more likely to be illiterate than White and non-migrant people. The explanation for this apparent paradox is that Black and migrant people were more likely to live in or move to areas with lower illiteracy rates, and therefore the aggregate data masked the individual-level relationship.
...
Let us suppose that the retail store chain knows the quantities of goods sold in different stores and, at the same time, demographic data about consumers in the different areas served by those stores.
Therefore, it would be tempting to link the percentage of young people to the quantities of different goods sold, suggesting that goods that sell more in stores with younger consumers are exactly the goods purchased by young consumers.

However, that could lead to false findings. In fact, when we consider data on cities, it might well be that stores with a greater share of young consumers are located in central areas near universities, where richer people also usually live. Therefore, even if young people might be more price-sensitive consumers, which is often the case, their habits would be masked by their neighbors' habits.
...
However, even at that level of aggregation, individual-level relationships may be severely masked.
...
George Wallace performed best in the Southern states, where the proportion of the Black population was generally higher than in the rest of the country. Therefore, a naive analysis of the aggregate data would suggest that Black people were more likely to vote for George Wallace: States with larger Black populations also had higher proportions of votes for him.
...
Both sections draw heavily on \citet{kuriwaki2026roleconfounderslinearityecological}, where the authors review ecological inference methods, and on \citet{mccartan2025identificationsemiparametricestimationconditional}, where they present the semiparametric method for ecological inference implemented in the R package \texttt{seine} (\citet{seine}) and experimented in this dissertation.
...
After presenting the model, I will use synthetic examples to illustrate how the different methods works and assess their performance in a controlled environment.

Then, I will present an application to real data from the 2020 US presidential election in Texas.
