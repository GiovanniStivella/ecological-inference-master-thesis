...
Alla fine quello di cui abbiamo bisogno per applicare il metodo di McCartan è un file analogo a quello prodotto da ALARM ma in cui aggiungiamo alcuni altri valori demografici.
